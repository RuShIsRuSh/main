...
class English extends Language {
    constructor(...args) {
        ...
        ` in this guild is set to: \`${prefix}\``
            ...
            COMMAND_HELP_NODM: "❌ | You have DMs disabled, here's a link to my commands > <https://etcroot.pw/amber/>",
            ...
            COMMAND_STATS: (memUsage, uptime, users, guilds, channels, klasaVersion, discordVersion, processVersion, message) => [
                "= STATISTICS =",
                "",
                `• Mem Usage  :: ${memUsage}/${(os.totalmem() / 1024 / 1024).toFixed(2)} MB`,
                `• Commands Ran  :: ${message.client.commandsRan + 1}`,
                `• Uptime     :: ${uptime}`,
                `• Users      :: ${users}`,
                `• Guilds    :: ${guilds}`,
                `• Channels   :: ${channels}`,
