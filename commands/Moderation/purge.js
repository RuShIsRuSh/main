...
class Purge extends Command {
  constructor(...args) {
    super(...args, {
      ...
      usage: "[limit:integer{,200}] [link|invite|bots|you|me|upload|user:user]",
      usageDelim: " "
    });
  }
  ...
  async run(msg, [limit = 50, filter = null]) {
    ...
    return msg.sendMessage(`Successfully deleted \`${messages.length}\` messages from ${msg.channel}.`).then((m) => m.delete({ timeout: 3000 }));
  }
