...
const constants = yaml.safeLoad(fs.readFileSync('commands/toxic/waifu-const.yml'));
const overrides = yaml.safeLoad(fs.readFileSync('commands/toxic/waifu-overrides.yml'));
