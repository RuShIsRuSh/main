		...
		if (User === null || User === undefined) {
			await message.channel.send({
				embed: {
					...
					description: `You currently have ${message.author.settings.won} ${this.client.constants.currency}.`,
					footer: {
			...
			await message.channel.send({
				embed: {
					...
					url: `${process.env.website}`,
					description: `<@${User.id}> currently has ${User.settings.won} ${this.client.constants.currency}.`,
					footer: {
						text: `${this.client.user.username} v${configuration.version} powered by ${process.env.botName}`,
					},
				},
